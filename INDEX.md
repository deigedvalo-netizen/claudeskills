...
| repo-analyst | analysis | prompts/analysis/repo-analyst.md | Stage 3; maps the target repo's current state — impacted modules, dependencies, constraints — as facts for Design |
...
| maintenance-triager | maintenance | prompts/maintenance/maintenance-triager.md | Stage 8; triages post-release signals into routed, severity-ranked findings via ROUTER.md |
